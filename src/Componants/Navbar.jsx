        ...
        {showProfile?<Profile />:""}
            <div className='w-full flex justify-between items-center font-semibold'>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    {userData ?
                        <p className='bg-purple-900 text-white px-3 py-1 rounded-full flex items-center justify-center cursor-pointer font-bold' onClick={() => { showProfile ? setShowProfile(false) : setShowProfile(true) }}>{userData.username[0].toUpperCase()}</p>   //hover:bg-black hover:text-white
                        :
